// UserModeApp.cpp: определ€ет точку входа дл€ консольного приложени€.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	while (true)
	{
		...
		DeviceIoControl(//‘ункци€ DeviceIoControl отправл€ет управл€ющий код непосредственно указанному драйверу устройства, заставл€€ соответствующее устройство выполнить соответствующую операцию.
			hDriverFile,
		...
		GetOverlappedResult( //будет дожидатьс€ завершени€ выполнени€ операции 
			hDriverFile, 
			&ov,
			&dwBytesReturned, 
			TRUE
